...
class RpcHelperTest {
	...
	public void testGetJSONArray() throws JSONException {
		...
		Item one = new ItemBuilder().setItemId("one").setDistance(5.1).setRating(5).setCategories(category).build();
		Item two = new ItemBuilder().setItemId("two").setDistance(20.3).setRating(5).setCategories(category).build();
