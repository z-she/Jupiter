...
public class Item {
	...
	public JSONObject toJSONObject() {
		...
		try {
			if (itemId != null) obj.put("item_id", itemId);
			if (name != null) obj.put("name", name);
			obj.put("rating", rating);
			if (address != null) obj.put("address", address);
			if (categories != null) obj.put("categories", new JSONArray(categories));
			if (imageUrl != null) obj.put("image_url", imageUrl);
